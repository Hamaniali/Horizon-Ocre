(() => {
          ...
          (e.exports = function (e, t) {
            ...
            function j(t, r) {
              var l,
                f = e(r),
                u = e.data(r, h);
              u || (u = e.data(r, h, { form: f })), E(u);
              var g = f.closest("div.w-form");
              (u.done = g.find("> .w-form-done")),
                (u.fail = g.find("> .w-form-fail")),
                (u.fileUploads = g.find(".w-file-upload")),
                  ...
                  p.on(
                    ...
                    function () {
                      a(
                        ...
                        r,
                        (e) => {
                          (u.turnstileToken = e), E(u), U(f, !1);
                        },
                        () => {
                          E(u), u.btn && u.btn.prop("disabled", !0), U(f, !1);
                        }
                      );
                    }
                  ));
              ...
              u.done.attr("aria-label") || u.form.attr("aria-label", v),
                u.done.attr("tabindex", "-1"),
                u.done.attr("role", "region"),
                u.done.attr("aria-label") ||
                  u.done.attr("aria-label", v + " success"),
                u.fail.attr("tabindex", "-1"),
                u.fail.attr("role", "region"),
                u.fail.attr("aria-label") ||
                  u.fail.attr("aria-label", v + " failure");
              var w = (u.action = f.attr("action"));
              if (
                ((u.handler = null),
                (u.redirect = f.attr("data-redirect")),
                k.test(w))
              ) {
                u.handler = W;
                return;
            ...
            function E(e) {
              ...
              t.prop("disabled", i),
                ...
                i || ((e.originalWidth = void 0), (e.originalLabel = void 0));
            }
            function S(e) {
              var t = e.btn,
                i = e.wait;
                    ...
                    (!y || n.env("preview")) &&
                      ...
                      (function () {
                        ...
                        p.on(
                          ...
                          (i) => {
                            e(i.target).siblings(t).toggleClass(n);
                          }
                        ),
                          p.on(
                            "change",
                            ...
                            (a) => {
                              e(`input[name="${a.target.name}"]:not(${t})`).map(
                                (t, a) => e(a).siblings(i).removeClass(n)
                              );
                              let r = e(a.target);
                          ...
                          o.forEach(([t, i]) => {
                            p.on(
                              "focus",
                              h + ` form input[type="${t}"]:not(` + i + ")",
                              (t) => {
                                e(t.target).siblings(i).addClass(a),
                                  e(t.target)
                                    .filter(
            ...
            function W(i) {
              ...
              var n,
                a = i.form,
                r = {};
              if (/^https/.test(m.href) && !/^https/.test(i.action))
              ...
              (r["b_" + d + "_" + (f = l.substring(f, l.indexOf("&", f)))] =
                ""),
                e
  ...
  var n = i.O(void 0, ["219", "113"], function () {
    return i(64429);
  });
  n = i.O(n);
})();
